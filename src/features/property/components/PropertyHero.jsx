    ...
    <>
      ...
      <div className="grid grid-cols-4 grid-rows-2 gap-3 h-[500px] mb-12">
        ...
        <div className="col-span-2 row-span-2 overflow-hidden rounded-xl">
          <img src={images[0]} className="w-full h-full object-cover hover:scale-105 transition duration-500" alt="Property"/>
        </div>

        {images.slice(1, 5).map((img, i) => (
          <div key={i} className="overflow-hidden rounded-xl">
            <img src={img} className="w-full h-full object-cover hover:scale-105 transition duration-500" alt={`Property view ${i + 2}`}/>
          </div>
        ))}
