    ...
    <section className="py-16 px-6 lg:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-end mb-10">
          ...
          <Button variant="ghost" className="text-primary font-bold transition-all hover:translate-x-1" asChild>
            <Link to="/explore">
              See all listings →
            </Link>
          </Button>
          ...
          {listings.map((home) => (
            ...
            >
              ...
              <CardContent className="p-5">
                <h3 className="text-lg font-bold mb-1 group-hover:text-primary transition-colors">{home.title}</h3>
