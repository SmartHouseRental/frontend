                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-64">
                      <DropdownMenuItem className="cursor-pointer">
                        ...
                        <span>Regenerate PDF Draft</span>
                      </DropdownMenuItem>
                      <DropdownMenuItem className="cursor-pointer">
                        <CheckCircle2 size={16} className="mr-2" />
                        <span>Mark Payment Confirmed</span>
                      </DropdownMenuItem>
                      <DropdownMenuItem className="cursor-pointer">
                        <Mail size={16} className="mr-2" />
                        <span>Notify All Parties</span>
                      </DropdownMenuItem>
                      <DropdownMenuSeparator />
                      <DropdownMenuItem className="cursor-pointer text-rose-600 focus:text-rose-600 font-bold">
                        <XCircle size={16} className="mr-2" />
                        <span>Force Terminate Lease</span>
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
